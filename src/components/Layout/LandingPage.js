...
const LandingPage = () => {
  ...
  return (
    <>
      <div className="flex justify-center items-center px-6 mb-16 text-center grid grid-cols-2 gap-8 ml-12">
      ...
      <div className="flex justify-center items-center ">
        <div className="h-[350px] w-72 border-2 rounded-xl flex flex-col items-center justify-center bg-white shadow-md mr-10 cursor-pointer">
          <img
            src={Animish}
            alt="Animish Chopade"
        ...
        <div className="h-[350px] w-72 border-2 rounded-xl flex flex-col items-center justify-center bg-white shadow-md cursor-pointer">
          <img
            src={Vrushabh}
