...
const sections = [
  {
    ...
    subtitle: 'Support your users with popular topics',
  ...
  },
  {
    ...
    subtitle: 'Personalise the support experience',
    text: 'Statistics show that people browsing your webpage who receive live assistance with a chat widget are more likely to make a purchase.',
    image: illustration02,
  },
  {
    title: 'Live Assistance',
    subtitle: 'Scale your sales using automation',
    text: 'Statistics show that people browsing your webpage who receive live assistance with a chat widget are more likely to make a purchase.',
    image: illustration03,
  },
  {
    title: 'Satisfaction Guaranteed',
    subtitle: 'Make customer satisfaction easier',
    text: 'Statistics show that people browsing your webpage who receive live assistance with a chat widget are more likely to make a purchase.',
    image: illustration04,
  },
];
...
function Demo() {
  useEffect(() => {
    const handleScroll = () => {
      ...
      stickySections.forEach((section, index) => {
        ...
        section.style.setProperty('--stick-visibility', isActive ? '1' : '0');
        section.style.setProperty('--stick-scale', isActive ? '1' : '0.9');
      });
    };
  ...
  return (
    <div className="font-inter antialiased bg-slate-50 min-h-screen overflow-hidden">
      <main className="w-full max-w-6xl mx-auto px-4 md:px-6 py-24">
        <div className="h-[calc(100vh-6rem)] flex items-center justify-center text-4xl font-bold text-slate-300 text-center">
          Scroll down
        </div>

        <div className="max-w-md mx-auto lg:max-w-none lg:min-h-[400vh]" data-sticky-container>
          {sections.map((section, index) => (
            <div
              key={index}
              className="lg:sticky lg:top-0 lg:h-screen space-y-16 lg:space-y-0"
              data-sticky-section
              style={{
                '--stick-visibility': 0,
                '--stick-scale': 0.9,
            ...
            >
              <div className="lg:absolute lg:inset-0 flex flex-col lg:flex-row space-y-4 lg:space-y-0 lg:space-x-20">
                <div className="flex-1 flex items-center lg:opacity-[var(--stick-visibility)] transition-opacity duration-300">
